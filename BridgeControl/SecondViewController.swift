...
//  BridgeControl
//
//  Created by Collin Scott on 11/23/18.
//  Copyright © 2018 collinscott. All rights reserved.
//
...
//        NotificationCenter.default.addObserver(self, selector: #selector(self.applicationWillEnterForeground(notification:)), name: Notification.Name.UIApplication.willEnterForegroundNotification, object: app)
